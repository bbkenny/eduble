    ...
    <div className="min-h-screen bg-gradient-to-br from-eduble-light to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Monitor your child&apos;s academic progress in real-time</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-eduble-mint">
            <h3 className="text-gray-600 text-sm font-semibold mb-2">Avg Score</h3>
            <p className="text-3xl font-bold text-eduble-slate">91</p>
            <p className="text-green-600 text-sm mt-2">Excellent performance</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-eduble-mint">
            <h3 className="text-gray-600 text-sm font-semibold mb-2">Behavior</h3>
            <p className="text-3xl font-bold text-eduble-slate">Good</p>
            <p className="text-blue-600 text-sm mt-2">Positive feedback from teachers</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-bold text-eduble-slate mb-4">Grade Trends</h2>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={gradeData}>
                ...
                <Legend />
                <Line type="monotone" dataKey="math" stroke="#98FF98" strokeWidth={2} />
                <Line type="monotone" dataKey="english" stroke="#334155" strokeWidth={2} />
                <Line type="monotone" dataKey="science" stroke="#64b5f6" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-bold text-eduble-slate mb-4">Attendance Breakdown</h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={attendanceData}
          ...
          <div className="lg:col-span-3 bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-bold text-eduble-slate mb-4">Behavioral Assessment</h2>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-bold text-eduble-slate mb-4">Recent Updates</h2>
          <div className="space-y-4">
            <div className="flex items-start border-l-4 border-eduble-mint p-4 bg-gradient-to-r from-eduble-mint/5 to-transparent rounded">
              <div className="flex-1">
                <h3 className="font-semibold text-eduble-slate">Math Test Score: 96%</h3>
                <p className="text-gray-600 text-sm">Excellent performance on algebra unit</p>
            ...
            <div className="flex items-start border-l-4 border-blue-400 p-4 bg-gradient-to-r from-blue-50 to-transparent rounded">
              <div className="flex-1">
                <h3 className="font-semibold text-eduble-slate">Perfect Attendance Week</h3>
                <p className="text-gray-600 text-sm">5/5 days present this week</p>
